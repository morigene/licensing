...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (request.getServletPath().contains("/api/v1/account-access")) {
        ...
        try {
            ...
            if (userEmail == null || SecurityContextHolder.getContext().getAuthentication() != null) {
                ...
                throw new ApiException(403, HttpStatus.UNAUTHORIZED.name(), "MISSING_TOKEN", "Token is missing in your header");
            }
            ...
            if (!jwtService.isTokenValid(jwt, userDetails) || !isTokenValid) {
                ...
                logger.warn("Invalid token or expired token for user: {}", userEmail);

                throw new ApiException(403, HttpStatus.FORBIDDEN.name(), "INVALID_TOKEN", "Token is Invalid or " +
                        "it is expired");
            }
